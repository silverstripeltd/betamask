...
mix
  .js(`${srcFolder}/js/cms-refresh.js`, "/")
  .js(`${srcFolder}/js/pre-cms-refresh.js`, "/")
  .sass(`${srcFolder}/scss/cms-refresh.scss`, "/", sassOptions)
  .sass(`${srcFolder}/scss/pre-cms-refresh.scss`, "/", sassOptions);
